...
namespace TestIndianStateCensusAnalyser
{
    public class Tests
    {
        static string indianStateCensusHeaders = "State,Population,AreaInSqKm,DensityPerSqKm";
        static string indianStateCodeHeaders = "SrNo,State Name,TIN,StateCode";
        static string indianStateCensusFilePath = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delemiterIndianCensusFilePath = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\IndianStateCesusDelimeter.csv";
        static string wrongIndianStateCensusFileType = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\IndianStateCensus.txt";
        static string indianStateCodeFilePath = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\IndiaStateCodes.csv";
        static string wrongIndianStateCodeFileType = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\IndiaStateCensusData.txt";
        static string delimiterIndianStateCodeFilePath = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\DelimiterIndiaStateCodes.csv";
        static string wrongHeaderStateCodeFilePath = @"C:\Users\HP\Bridgelabz-145\Assignments_\Day 29\IndianStateCensusAnalyser\TestIndianStateCensusAnalyser\CSVFiles\WrongHeaderIndiaStateCodes.csv";
        ...
        {
            var censusException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(CensusAnalyser.Country.INDIA, delemiterIndianCensusFilePath, indianStateCensusHeaders));
        ...
        {
            var stateCodeException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(CensusAnalyser.Country.INDIA, delemiterIndianCensusFilePath, indianStateCodeHeaders));
